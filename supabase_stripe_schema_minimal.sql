-- MailoReply AI - Stripe Integration Schema (MINIMAL SAFE VERSION)
-- Avoids all system table checks that could cause issues
...
CREATE TYPE IF NOT EXISTS price_interval AS ENUM (
  'month',
  'year'
);
...
-- Simple extension usage tracking
...
-- Create indexes (PostgreSQL 9.5+ supports IF NOT EXISTS)
